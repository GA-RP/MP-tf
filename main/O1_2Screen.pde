//class O1_2Screen que implementa a interface Screen
class O1_2Screen implements Screen {
  ...
  O1_2Screen(Movie video) {  //construtor recebe o vídeo a reproduzir
  ...
  public void update() {
    ...
    if (!finished && video.duration() > 0 && video.time() >= video.duration() - 0.05) {
      ...
      currentScreen = new O1Choice2Screen(frames[2]);  //usa o frame correspondente carregado na main
    }
  }
