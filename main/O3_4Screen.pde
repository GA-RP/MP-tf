//class O3_4Screen que implementa a interface Screen
class O3_4Screen implements Screen {
  ...
  O3_4Screen(Movie video) {  //construtor recebe o vídeo a reproduzir
  ...
  public void update() {
    ...
    if (!finished && video.duration() > 0 && video.time() >= video.duration() - 0.05) {
      ...
      currentScreen = new FinalBad(videos[13]);  //usa o frame correspondente carregado na main
    }
  }
