//class O3_1Screen que implementa a interface Screen
class O3_1Screen implements Screen {
  ...
  O3_1Screen(Movie video) {  //construtor recebe o vídeo a reproduzir
  ...
  public void update() {
    ...
    if (!finished && video.duration() > 0 && video.time() >= video.duration() - 0.05) {
      ...
      currentScreen = new O3Choice2Screen(frames[4]);  //usa o frame correspondente carregado na main
    }
  }
