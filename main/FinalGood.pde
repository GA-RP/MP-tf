//class FinalGood que implementa a interface Screen
class FinalGood implements Screen {
  ...
  FinalGood(Movie video) {  //construtor recebe o vídeo a reproduzir
  ...
  public void display() {
    background(0, 255, 0);  //ecrã com fundo preto - MUDAR DEPOIS
